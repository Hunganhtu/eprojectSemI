                ...
                <div class="pr-70 res-991-pr-0">
                    ...
                    <div class="section-title clearfix">
                        <div class="title-header">
                            ...
                            <h2 class="title">Our Company History</h2>
                        </div>
                    ...
                    <p class="mb-45 mt_10">Ac bibendum ac in erat. Donec posuere consectetuer volutpat rutrum ac, sollicitudin quam quisque, at interdum dignissim, fringilla elit risus lorem eu condimentum eros mollis. Nam liber tempor cum soluta nobis eleifend option congue nihil doming id quod mazim placerat facer possim assum typi non habent claritatem insitam.um dignissim, fringilla elit risus lorem eu cond</p>
                    <div class="row">
                        <div class="col-lg-6">
                                ...
                                <div class="layer-content">
                                    ...
                                    <div class="featured-icon-box style2">
                                        ...
                                        <div class="featured-content">
                                            <div class="featured-desc"><p>Contact Us</p></div>
                                            <div class="featured-title"><h5>+123 - 456 - 7890</h5></div>
                                        </div>
                            ...
                            <div class="ttm-col-bgcolor-yes ttm-bg ttm-bgcolor-grey spacing-1">
                                ...
                                <div class="layer-content">
                                    ...
                                    <div class="featured-icon-box style2">
                                        ...
                                        <div class="featured-content">
                                            <div class="featured-desc"><p>Email Us:</p></div>
                                            <div class="featured-title"><h5>abcd@gmail.com</h5></div>
                                        </div>
                                    </div><!-- featured-icon-box end-->
                                </div>
                            </div>
                    ...
                    <div class="pt-35">
                        <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-btn-style-fill ttm-btn-color-skincolor" href="#">Get A Quote!</a>
                    </div>
                </div>
            </div>
                ...
                <div class="ttm_single_image-wrapper position-relative ml-15 res-991-ml-0 res-991-mt-30">
                    ...
                    <div class="ttm-fid inside ttm-fid-with-icon ttm-fid-view-lefticon ttm-highlight-fid">
                        ...
                        <div class="ttm-fid-contents">
                            <h3 class="ttm-fid-title"><span>founded in</span></h3>
...
<!-- fid-section -->
<section class="fid-section ttm-bg ttm-bgcolor-skincolor clearfix">
    ...
    <div class="container">
        <div class="row ttm-facts-colum-sep">
            ...
            <div class="col-md-3 col-sm-3 co-xs-12">
                <div class="ttm-fid inside ttm-fid-view-topicon">
                    <div class="ttm-fid-icon-wrapper"><i class="themifyicon ti-truck"></i></div>
                    <div class="ttm-fid-contents">
                        <h4><span   data-appear-animation = "animateDigits"
                                    data-from             = "0"
                                    data-to               = "528"
                        ...
                        <h3 class="ttm-fid-title"><span>Delievery Boys<br></span></h3>
                    </div><!-- ttm-fid-contents end-->
                </div>
            </div>
            <div class="col-md-3 col-sm-3 co-xs-12">
                <div class="ttm-fid inside ttm-fid-view-topicon">
                    <div class="ttm-fid-icon-wrapper"><i class="themifyicon ti-shopping-cart-full"></i></div>
                    <div class="ttm-fid-contents">
                        <h4><span   data-appear-animation = "animateDigits"
                                    data-from             = "0"
                                    data-to               = "124"
...
<!--team-section-->
<section class="team-section ttm-bgcolor-white clearfix">
     <div class="container">
        <!-- row -->
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="mt-10 mb_15">
                    <div class="slick_slider" data-slick='{"slidesToShow": 3, "slidesToScroll": 3, "arrows":false, "autoplay":true, "rows":1}'>
