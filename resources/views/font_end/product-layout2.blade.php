                ...
                <div class="col-md-12">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="page-title-heading">
                            <h1 class="title">Product Layout 02</h1>
                        </div>
                        <div class="breadcrumb-wrapper">
                            <span class="mr-1"><i class="ti ti-home"></i></span>
                            <a title="Homepage" href="index.html">Home</a>
                            <span class="ttm-bread-sep">&nbsp;/&nbsp;</span>
                            <span class="ttm-textcolor-skincolor">Product Layout 02</span>
                        </div>
                    </div>
                </div>
            </div>  
                                            ...
                                            <div class="pr-35 res-767-pr-15">
                                                <div class="easyzoom easyzoom--overlay easyzoom--with-thumbnails">
                                                    <a href="images/product/pro-01-plus.png">
                                                        <img class="img-fluid" src="images/product/pro-01-plus.png" alt="" />
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
