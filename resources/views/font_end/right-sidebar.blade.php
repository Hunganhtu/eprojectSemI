            ...
            <div class="col-md-12">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="breadcrumb-wrapper">
                        ...
                        <span class="ttm-textcolor-skincolor">Right Sidebar</span>
                    </div>
                </div>
            </div>
        </div>  
        ...
        <div class="row">
            <div class="col-lg-9 content-area">
                ...
                <div class="banner-image mb-40">
                    <a href="#"><img class="img-fluid" src="images/banner-eight.jpg" alt=""></a>
                                ...
                                <div class="products row">
                                        ...
                                        <div class="product-box">
                                            ...
                                            <div class="product-box-inner">
                                                <div class="product-image-box">
                                                    <img class="img-fluid pro-image-front" src="images/product/pro-front-10.png" alt="">
                                                    <img class="img-fluid pro-image-back" src="images/product/pro-back-10.png" alt="">
                                                </div>
                                    ...
                                    <div class="product col-md-3 col-sm-6 col-xs-12">
                                        <div class="product-box">
                                            ...
                                            <div class="product-box-inner">
                                                <div class="product-image-box">
                                                    <img class="img-fluid pro-image-front" src="images/product/pro-front-09.png" alt="">
                                                    <img class="img-fluid pro-image-back" src="images/product/pro-back-09.png" alt="">
                                                </div>
                                                <div class="product-btn-links-wrapper">
                                                    <div class="product-btn"><a href="#" class="add-to-cart-btn tooltip-top" data-tooltip="Add To Cart"><i class="ti ti-shopping-cart"></i></a>
                                                    </div>
                                    ...
                                    <div class="product col-md-3 col-sm-6 col-xs-12">
                                        <div class="product-box">
                                            ...
                                            <div class="product-box-inner">
                                                <div class="product-image-box">
                                                    <img class="img-fluid pro-image-front" src="images/product/pro-back-01.png" alt="">
                                                    <img class="img-fluid pro-image-back" src="images/product/pro-front-01.png" alt="">
                                                </div>
                                                <div class="product-btn-links-wrapper">
                                                    <div class="product-btn"><a href="#" class="add-to-cart-btn tooltip-top" data-tooltip="Add To Cart"><i class="ti ti-shopping-cart"></i></a>
                                                    </div>
                                            ...
                                            <div class="product-content-box">
                                                ...
                                                <span class="price">
                                                    <span class="product-Price-amount">
                                                        <span class="product-Price-currencySymbol">$</span>39.00
                                                    </span>
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="product col-md-3 col-sm-6 col-xs-12">
                                        <div class="product-box">
                                            ...
                                            <div class="product-box-inner">
                                                <div class="product-image-box">
                                                    <div class="onsale">Sale!</div>
                                                    <img class="img-fluid pro-image-front" src="images/product/pro-back-06.png" alt="">
                                                    <img class="img-fluid pro-image-back" src="images/product/pro-front-06.png" alt="">
                                                </div>
                                                <div class="product-btn-links-wrapper">
                                                    <div class="product-btn"><a href="#" class="add-to-cart-btn tooltip-top" data-tooltip="Add To Cart"><i class="ti ti-shopping-cart"></i></a>
                                                    </div>
                                ...
                                <div class="products row">
                                    ...
                                    <div class="product col-md-3 col-sm-6 col-xs-12">
                                        <div class="product-box">
                                            ...
                                            <div class="product-content-box">
                                                <a class="product-title" href="product-layout1.html" tabindex="0">
                                                    <h2>Impact Wrench</h2>
                                                </a>
                                                <div class="star-ratings">
                                                    <ul class="rating">
                                    ...
                                    <div class="product col-md-3 col-sm-6 col-xs-12">
                                        <div class="product-box">
                                            ...
                                            <div class="product-box-inner">
                                                <div class="product-image-box">
                                                    <img class="img-fluid pro-image-front" src="images/product/pro-back-10.png" alt="">
                                                    <img class="img-fluid pro-image-back" src="images/product/pro-front-10.png" alt="">
                                                </div>
                                                <div class="product-btn-links-wrapper">
                                                    <div class="product-btn"><a href="#" class="add-to-cart-btn tooltip-top" data-tooltip="Add To Cart"><i class="ti ti-shopping-cart"></i></a>
                                                    </div>
            ...
            <div class="col-lg-3 widget-area sidebar-right">
                        ...
                        <div class="price_slider_wrapper">
                            ...
                            <form method="get">
                                ...
                                <div class="price_slider_amount">
                                    ...
                                    <input type="text" id="max_price" name="max_price" value="$780" data-max="$2400" placeholder="Max price" />
                ...
                <aside class="widget products top-rated-products">
                    ...
                    <ul class="product-list-widget product">
                        <li>
                            <a href="#"><img src="images/product/pro-front-10.png" alt=""></a>
                            <div class="product-content-box">
                                <div class="star-ratings">
                                    <ul class="rating">
                                        <li><i class="fa fa-star"></i></li>
                         ...
                         <li>
                            <a href="#"><img src="images/product/pro-front-08.png" alt=""></a>
                            <div class="product-content-box">
                                <div class="star-ratings">
                                    <ul class="rating">
                                        <li><i class="fa fa-star"></i></li>
                ...
                <aside class="widget widget_media_image banner-image">
                    <a href="#"><img class="img-fluid" src="images/widget-banner-three.jpg" alt="widget-banner"></a>
                </aside>
            </div>
            <div class="col-lg-12">
